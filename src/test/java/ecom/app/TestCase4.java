...
public class TestCase4 extends Capabilities {
    @Test
    public void addProductTocart() throws MalformedURLException, InterruptedException {
...
//        Assert.assertEquals(sum, totalValue);
    ...
    @Test
    public void shoppingCartMobileGesturesCheck() throws MalformedURLException, InterruptedException {
        AndroidDriver driver = androidCapabilities();
        driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
